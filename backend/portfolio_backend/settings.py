...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-8!(bthy@!@+z!a^d#h(ht0&7b+bs1tqku+@8=fz5j5)_=!nv)*')
...
CORS_ALLOW_ALL_ORIGINS = True  # Set to True to handle any frontend domain during deployment
